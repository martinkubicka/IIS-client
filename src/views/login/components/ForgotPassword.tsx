 ...
 * @date 17.12.2023
 * @brief Definition of forgot password component
 */
        ...
        >
          <Stack spacing={2}>
            <FormControl error={!validEmail}>
              ...
              />
              {!validEmail && (
                <FormHelperText>Email must be in right format!</FormHelperText>
              )}
            </FormControl>
            ...
            <Box sx={{ display: "flex", justifyContent: "center", gap: 3 }}>
              ...
              <Button size="lg" type="submit" disabled={!validEmail}>
                Reset password
              </Button>
            </Box>
          </Stack>
